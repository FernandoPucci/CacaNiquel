...
public class Constantes {
    ...
    public static final String PATH_FILE_0 = "icons/img0r.png";
    public static final String PATH_FILE_1 = "icons/img1r.png";
    public static final String PATH_FILE_2 = "icons/img2r.png";
    ...
    public static final File FILE_2 = new File(PATH_FILE_2);
    public static final File FILE_3 = new File(PATH_FILE_3);
